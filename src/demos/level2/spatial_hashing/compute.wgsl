...
struct SimParams {
  deltaT : f32,        // 时间步长
  rule1Distance : f32,  // 凝聚规则的距离阈值
  rule2Distance : f32,  // 分离规则的距离阈值
  rule3Distance : f32,  // 对齐规则的距离阈值
  rule1Scale : f32,     // 凝聚力的强度系数
  rule2Scale : f32,     // 分离力的强度系数
  rule3Scale : f32,     // 对齐力的强度系数
};
